...
//ExitButton, wird beim Screen ''Pläne'' bei den Modals verwendet:
...
//AbbrechenButton, wird beim Screen ''OwnWorkouts'' verwendet, um das löschen der eigenen Workouts abzubrechen:
export function AbbrechenButton({ text, onPress }) {
  return (
    <TouchableOpacity onPress={onPress}>
      <View style={styles.abbrechenButton}>
        <Text style={styles.abbrechenText}>{text}</Text>
      </View>
    </TouchableOpacity>
  )
}
