...
//CreateAccountModal wird beim ''Feed'' Screen NICHT verwendet:
export function CreateAccountModal(props) {
  const { onPressExit, visible, addAccount } = props;
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View style={globalStyles.neuesWorkoutModal}>
            <ScrollView>
              <View style={{ alignItems: 'center' }}>
                <ExitButton onPress={onPressExit}/>
                {/* <ErstellenButton onPress={addAccount}/> */}
              </View>
            </ScrollView>
          </View>
        </TouchableWithoutFeedback>
