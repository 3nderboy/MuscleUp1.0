  ...
  return (
        <View style={{ flex: 1, marginVertical: 0, marginHorizontal: 0 }}>
          <ScrollView>
            ...
            <View style={{ flex: 1, position: 'absolute', backgroundColor: 'turquoise', top: 0, bottom: 800, left: 0, right: 0, paddingBottom: 400, borderBottomLeftRadius: 30, borderBottomRightRadius: 30, zIndex: 1  }}>
            ...
            <View style={{ paddingTop: 210 }}>
              <View style={globalStyles.container1}>
                ...
                <Button 
                    ...
                    onPress={() => {
                        navigation.navigate('Übungen', { screen: 'Eigene Workouts' })
                    }}
                />
                <Button 
                    title='Workouts'
                    onPress={() => {
                        navigation.navigate('Übungen', { screen: 'Workouts' })  //('Übung1', { ÜbungsName: 'hello' })
                    }}
                />
              </View>
            </View>
