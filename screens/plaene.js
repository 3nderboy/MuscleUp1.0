  ...
  return (
    <View style={{ flex: 1, marginVertical: 0, marginHorizontal: 0 }}>
      <ScrollView>
        ...
        <View style={{ flex: 1, position: 'absolute', backgroundColor: 'turquoise', top: 0, bottom: 785, left: 0, right: 0, borderBottomLeftRadius: 30, borderBottomRightRadius: 30, zIndex: 1 }}>
          ...
          <View style={{ flex: 1, alignItems: 'center', paddingTop: 70, paddingBottom: 20, zIndex: 1 }}>
            <UserInformationCard>
              <View style={{ alignItems: 'center', paddingHorizontal: 10 }}>
                ...
                <Text style={globalStyles.basicBoldText}>für deinen Körper mithilfe</Text>
