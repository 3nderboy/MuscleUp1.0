...
//Das Validierungs-Schema mit der Hilfe von yup:
      ...
      >
        {(props) => (
          <View style={{ paddingTop: 25 }}>
            ...
            <TouchableOpacity style={{ borderWidth: 1, borderColor: 'lightgrey', borderRadius: 6, paddingVertical: 4 }}>
              <UebungPicker
                selectedValue={props.values.uebung5}
                onValueChange={props.handleChange('uebung5')} 
              />
            </TouchableOpacity>
            <View style={{ paddingVertical: 3 }}></View>
            ...
            <TouchableOpacity style={{ borderWidth: 1, borderColor: 'lightgrey', borderRadius: 6, paddingVertical: 4 }}>
              <UebungPicker
                selectedValue={props.values.uebung6}
                onValueChange={props.handleChange('uebung6')} 
              />
            </TouchableOpacity>
            <View style={{ paddingVertical: 3 }}></View>
            ...
            <TouchableOpacity style={{ borderWidth: 1, borderColor: 'lightgrey', borderRadius: 6, paddingVertical: 4 }}>
              <UebungPicker
                selectedValue={props.values.uebung7}
                onValueChange={props.handleChange('uebung7')} 
              />
            </TouchableOpacity>
            <View style={{ paddingVertical: 3 }}></View>
            ...
            <TouchableOpacity style={{ borderWidth: 1, borderColor: 'lightgrey', borderRadius: 6, paddingVertical: 4 }}>
              <UebungPicker
                selectedValue={props.values.uebung8}
                onValueChange={props.handleChange('uebung8')} 
              />
            </TouchableOpacity>
            <View style={{ paddingVertical: 3 }}></View>
            ...
            <TouchableOpacity style={{ borderWidth: 1, borderColor: 'lightgrey', borderRadius: 6, paddingVertical: 4 }}>
              <UebungPicker
                selectedValue={props.values.uebung9}
                onValueChange={props.handleChange('uebung9')} 
              />
            </TouchableOpacity>
            <View style={{ paddingVertical: 3 }}></View>
            ...
            <TouchableOpacity style={{ borderWidth: 1, borderColor: 'lightgrey', borderRadius: 6, paddingVertical: 4 }}>
              <UebungPicker
                selectedValue={props.values.uebung10}
                onValueChange={props.handleChange('uebung10')} 
              />
            </TouchableOpacity>
            <View style={{ paddingVertical: 3 }}></View>
            ...
            <TouchableOpacity style={{ borderWidth: 1, borderColor: 'lightgrey', borderRadius: 6, paddingVertical: 4 }}>
              <UebungPicker
                selectedValue={props.values.uebung11}
                onValueChange={props.handleChange('uebung11')} 
              />
            </TouchableOpacity>
            <View style={{ paddingVertical: 3 }}></View>
            ...
            <TouchableOpacity style={{ borderWidth: 1, borderColor: 'lightgrey', borderRadius: 6, paddingVertical: 4 }}>
              <UebungPicker
                selectedValue={props.values.uebung12}
                onValueChange={props.handleChange('uebung12')} 
              />
            </TouchableOpacity>
            <View style={{ paddingVertical: 3 }}></View>
            ...
            <TouchableOpacity style={{ borderWidth: 1, borderColor: 'lightgrey', borderRadius: 6, paddingVertical: 4 }}>
              <UebungPicker
                selectedValue={props.values.uebung13}
                onValueChange={props.handleChange('uebung13')} 
              />
            </TouchableOpacity>
            <View style={{ paddingVertical: 3 }}></View>
            ...
            <TouchableOpacity style={{ borderWidth: 1, borderColor: 'lightgrey', borderRadius: 6, paddingVertical: 4 }}>
              <UebungPicker
                selectedValue={props.values.uebung14}
                onValueChange={props.handleChange('uebung14')} 
              />
            </TouchableOpacity>
            <View style={{ paddingVertical: 3 }}></View>
            ...
            <TouchableOpacity style={{ borderWidth: 1, borderColor: 'lightgrey', borderRadius: 6, paddingVertical: 4 }}>
              <UebungPicker
                selectedValue={props.values.uebung15}
                onValueChange={props.handleChange('uebung15')} 
              />
            </TouchableOpacity>
            <View style={{ paddingVertical: 3 }}></View>
...
const UebungPicker = (props) => (
  ...
  >
    ...
    <Picker.Item label='Hantel-Presse (stehend)' value={'hantelnPressestehend'} />
...
function convertFormValuesToWorkout(values) {
  ...
  const { uebung1, uebung2, uebung3, uebung4, uebung5, uebung6, uebung7, uebung8, uebung9, uebung10, uebung11, uebung12, uebung13, uebung14, uebung15, ...rest } = values;
  const fullUebungen = [
    uebung1 && getFullUebung(uebung1),
    uebung2 && getFullUebung(uebung2),
    uebung3 && getFullUebung(uebung3),
    uebung4 && getFullUebung(uebung4),
    uebung5 && getFullUebung(uebung5),
    uebung6 && getFullUebung(uebung6),
    uebung7 && getFullUebung(uebung7),
    uebung8 && getFullUebung(uebung8),
    uebung9 && getFullUebung(uebung9),
    uebung10 && getFullUebung(uebung10),
    uebung11 && getFullUebung(uebung11),
    uebung12 && getFullUebung(uebung12),
    uebung13 && getFullUebung(uebung13),
    uebung14 && getFullUebung(uebung14),
    uebung15 && getFullUebung(uebung15),
