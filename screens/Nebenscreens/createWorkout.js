...
export default function CreateWorkout({ addWorkout }) {
  ...
  return (
    <View style={globalStyles.containerNormal}>
      <Formik
        initialValues={{ WorkoutName: '', Für: '', Sonst: '', Beschreibung: '', Wie: '', Dauer: '', Schwierigkeit: '', uebungen: '', }}
        ...
        {(props) => (
          <View style={{ paddingTop: 25 }}>
            ...
            <Picker 
              style={{ height: 35, width: 300, borderColor: 'grey', borderBottomWidth: 1 }}
              // mode='dropdown'
              selectedValue={props.values.uebungen}

              onValueChange={props.handleChange('uebungen')}

              value={props.values.title}
            >
              <Picker.Item label='Übungen' value='-' key='0' /> 
              <Picker.Item label='Sit-Ups' value='situps' key='1' />
              <Picker.Item label='Planke' value='planke' key='2' />
            </Picker>
