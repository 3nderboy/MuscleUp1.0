...
export default function Uebungen({ route, navigation }) {
  ...
  const [imageNameFront, setImageNameFront] = useState(MuskelmenschBilder['muskelmodellV']);
  const [imageNameBack, setImageNameBack] = useState(MuskelmenschBilder['muskelmodellH']);
